python get_text_from_url.py --output NER_V2_Outputs/ --split_by paragraph --input NER/lang_biography/als.csv
python get_text_from_url.py --output NER_V2_Outputs/ --split_by paragraph --input NER/lang_biography/kk.csv
python get_text_from_url.py --output NER_V2_Outputs/ --split_by paragraph --input NER/lang_biography/ig.csv
python get_text_from_url.py --output NER_V2_Outputs/ --split_by paragraph --input NER/lang_biography/uz.csv
